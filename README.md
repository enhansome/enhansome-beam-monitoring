...
* [Telemetry](https://github.com/beam-telemetry/telemetry) ⭐ 923 | 🐛 6 | 🌐 Erlang | 📅 2026-08-22 - dynamic dispatcher for Erlang metrics and instrumentations
...
* [AppSignal](https://github.com/appsignal/appsignal-elixir) ⭐ 292 | 🐛 18 | 🌐 Elixir | 📅 2026-09-23 - AppSignal
  Elixir integration package for gathering metrics, errors, and traces
* [New Relic](https://github.com/newrelic/elixir_agent) ⭐ 268 | 🐛 9 | 🌐 Elixir | 📅 2026-09-18 - New Relic's Elixir agent supports metrics, errors and distributed tracing
...
* [Sentry](https://github.com/getsentry/sentry-elixir) ⭐ 694 | 🐛 16 | 🌐 Elixir | 📅 2026-09-24 - official Elixir SDK for Sentry.io
